...
public class TemplateView extends FrameLayout {
    ...
    public void setNativeAd(NativeAd nativeAd) {
        ...
        if (starRating != null && starRating > 0) {
            ...
            tertiaryView.setText(secondaryText);
            tertiaryView.setVisibility(VISIBLE);
    ...
    public String getTemplateTypeName() {
        if (templateType == R.layout.ottshow_medium_template_view) {
            return MEDIUM_TEMPLATE;
        } else if (templateType == R.layout.ottshow_small_template_view) {
        ...
        try {
            templateType =
                    attributes.getResourceId(
                            R.styleable.TemplateView_gnt_template_type, R.layout.ottshow_medium_template_view);
        } finally {
            attributes.recycle();
        }
...
//        secondaryView = (TextView) findViewById(R.id.secondary);
        ...
        ratingBar = (RatingBar) findViewById(R.id.ad_stars);
