...
import com.showott.watchmovies.Main_Ads.admob_ads.Blue_mycustomtab.Blue_LoadCustom;
import com.showott.watchmovies.R;

import java.util.ArrayList;
import java.util.List;

public class ottshowtv_Adintermethod {
    ...
    private static ottshowtv_Adintermethod mInstance;

    public static NativeAd mNativebannerAd;
    public static NativeAd mNativeAd;

    public ottshowtv_Adintermethod(Context context) {
        activity = context;
    }
    ...
    public void addialogshow(Context activity) {
        ...
        adprogress.setContentView(R.layout.ottshow_ads_loading_dialog_inter);
        adprogress.show();
    }
    ...
    public static ottshowtv_Adintermethod getInstance(Context context) {
        activity = context;
        convertedObject = ottshowtv_Utils.getResponse(context);
        if (mInstance == null) {
            mInstance = new ottshowtv_Adintermethod(context);
        }
        return mInstance;
    }
    ...
    public void ShowotherInter(Activity activity, oncloseintent oncloseintent) {
        ...
        if (convertedObject.getCheckInter().equalsIgnoreCase(Constant.admob)) {
            ottshowtv_Adintermethod.adIntent1 = oncloseintent;
            adcount = SharedPreferencesManager.getInstance(activity).getNumberOfClicks();
            if (adcount == convertedObject.getAdcount()) {
                SharedPreferencesManager.getInstance(activity).storeClicks(1);
    ...
    public void adintercheck(ottshowtv_DataItem convertedObject, final Activity activity, String fbinter2, onAdIntent adIntent) {

        ottshowtv_Adintermethod.adIntent = adIntent;
        if (convertedObject.getCheckInter().equalsIgnoreCase(Constant.admob)) {
            addialogshow(activity);
    ...
    public void show_Appopen_Interstitial(Activity activity2, String fbinter2, MyCallback myCallback2) {
        ...
        if (!isAdAvailable()) {
            fullScreenContentCallback = new FullScreenContentCallback() {
                public void onAdDismissedFullScreenContent() {
                    if (ottshowtv_Adintermethod.myCallback != null) {
                        ottshowtv_Adintermethod.myCallback.OnCall();
                        ottshowtv_Adintermethod.myCallback = null;
                    }
                }
...
//                            TemplateView template = findViewById(R.id.admobmediumnative);
    ...
    public void inflateAd1(Activity activity, com.facebook.ads.NativeAd nativeAd, NativeAdLayout native_ad_container1) {
        ...
        adView = (LinearLayout) inflater.inflate(R.layout.ottshow_fb_native_ad_unit, native_ad_container1, false);
    ...
    public void inflateAd(Activity activity, NativeBannerAd nativeBannerAd, NativeAdLayout native_banner_ad_container) {
        ...
        LayoutInflater inflater = LayoutInflater.from(activity);
        adView = (LinearLayout) inflater.inflate(R.layout.ottshow_fb_native_banner_ad_layout, native_banner_ad_container, false);
...
//        q_native_banner = findViewById(R.id.q_native_banner);
    ...
    public void clearprefrence(Activity activity) {
        ottshowtv_Utils.saveStringtoPrefrence(activity, Constant.AdResponse, null);
        nativeBannerAd = null;
        nativeAd1 = null;
        mNativeAd = null;
